...
export function Footer() {
  return (
    <footer className="border-t border-white/5 bg-background mt-24">
      <div className="max-w-5xl mx-auto px-6 py-12 flex flex-col md:flex-row items-center justify-between gap-6">
        <p className="text-sm text-muted-foreground">
          &copy; {new Date().getFullYear()} Kevin Koshy. All rights reserved.
        </p>
        <div className="flex items-center gap-6 text-muted-foreground">
          <Link href="https://github.com/kevy-k" target="_blank" className="hover:text-foreground transition-colors">
